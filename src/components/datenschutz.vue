    ...
    <div class="row justify-content-center">
        <div class='col-10 datenschutz'>
            ...
            <p>Mit der folgenden Datenschutzerklärung möchten wir Sie darüber aufklären, welche Arten Ihrer
                ...
                im
                Rahmen der Erbringung unserer Leistungen als auch insbesondere auf unseren Webseiten, in mobilen
                Applikationen
            ...
            <p>max mustermann<br>musterstraße 100<br>musterstadt 99999</p>
            E-Mail-Adresse: <p><a href="mailto:musteremail@email.com">musteremail@email.com</a></p>
            Impressum: <p><a href="https://streetkitchen.catering/" target="_blank">https://streetkitchen.catering/</a></p>
        ...
        <div class="col-10">
            <button class="btn btn-primary" @click="backtostart()">Zurürck zum Anfang</button>
        </div> 
    </div>
</template>
<script setup>
